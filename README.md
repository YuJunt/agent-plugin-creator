...
[![CI](https://github.com/YuJunt/agent-plugin-creator/actions/workflows/ci.yml/badge.svg)](https://github.com/YuJunt/agent-plugin-creator/actions/workflows/ci.yml)
[![Release](https://github.com/YuJunt/agent-plugin-creator/actions/workflows/release.yml/badge.svg)](https://github.com/YuJunt/agent-plugin-creator/actions/workflows/release.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Version](https://img.shields.io/badge/version-1.4.0-blue.svg)](https://github.com/YuJunt/agent-plugin-creator/releases)
...
- 🔌 **多客户端适配** — 支持 Claude Code、Cursor、GitHub Copilot、OpenAI Codex、Google Gemini、豆包
...
# 或下载发布包
curl -L https://github.com/YuJunt/agent-plugin-creator/releases/latest/download/agent-plugin-creator-v1.4.0.zip -o plugin.zip
...
本项目内嵌了 Anthropic 官方的 `skill-creator` 和 `mcp-builder` 资源（位于 `official/` 目录），这些资源遵循 Apache License 2.0。详见 `official/` 目录下的许可证文件。
...
- Issue: [GitHub Issues](https://github.com/YuJunt/agent-plugin-creator/issues)
- 讨论: [GitHub Discussions](https://github.com/YuJunt/agent-plugin-creator/discussions)
